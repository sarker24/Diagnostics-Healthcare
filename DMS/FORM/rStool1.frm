...
Private Sub cmdPrint_Click()
    '==========direct print==========================
            ...
            Report44.FormulaFields.Item(2).text = Chr(34) & "Patient ID" & Chr(34)
            Report44.FormulaFields.Item(3).text = Chr(34) & "Received Date" & Chr(34)
            Report44.FormulaFields.Item(4).text = Chr(34) & "Delivered Date" & Chr(34)
            Report44.FormulaFields.Item(5).text = Chr(34) & "Patient Name" & Chr(34)
            ...
            Report44.FormulaFields.Item(11).text = Chr(34) & "Clinical Pathological Report" & Chr(34)
            ...
            Report44.FormulaFields.Item(15).text = Chr(34) & "Normal Values" & Chr(34)
...
Private Sub Form_KeyPress(KeyAscii As Integer)
    If KeyAscii = 27 Then
    If rStool1.DataGrid1.Visible = True Then
        rStool1.DataGrid1.Visible = False
    Else
        Unload Me
    End If
    End If
