    ...
    If Adodc2.Recordset.RecordCount > 0 Then
        ...
        Select Case Doc_List_MODE
               Case "frmPatient_Info"
                     ...
                     frmPatient_Info.txtRefer_Code = Adodc2.Recordset!refer_code
                     frmPatient_Info.txtDoc_Name = Trim(List.text)
                     Unload Me
                     'StrRef_Code = ""
