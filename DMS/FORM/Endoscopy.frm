...
Begin VB.Form rEndoscopy 
   BackColor       =   &H00C0B4A9&
   Caption         =   "Lab Report Format [ENDOSCOPY]"
   ClientHeight    =   8595
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   11430
   DrawWidth       =   2
   Icon            =   "Endoscopy.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   LockControls    =   -1  'True
   MaxButton       =   0   'False
...
Private Sub Form_KeyPress(KeyAscii As Integer)
    If KeyAscii = 27 Then
    If rEndoscopy.DataGrid1.Visible = True Then
        rEndoscopy.DataGrid1.Visible = False
    Else
        Unload Me
    End If
    End If
...
Public Sub Temp_rst1()
    ...
    DataGrid2.Columns(1).Width = 5609.764
...
Private Sub GetTestName()
  ...
  Adodc7.RecordSource = "exec test_result_select1 1,'" + "13E" + "'"
  Adodc7.Refresh
...
Private Sub GetResult()
  Adodc7.connectionstring = strcn.Connection
  Adodc7.RecordSource = "exec test_result_select 1,'" + ComTest_Name + "','" + "13" + "'"
  Adodc7.Refresh
