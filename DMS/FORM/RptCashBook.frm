      ...
      Begin MSComctlLib.ImageList ImageList1 
         ...
         BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
            ...
            BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "RptCashBook.frx":000C
               Key             =   ""
            EndProperty
            BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "RptCashBook.frx":08E6
               Key             =   ""
            EndProperty
            BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "RptCashBook.frx":11C0
               Key             =   ""
            EndProperty
         EndProperty
      End
...
'    rsMaster.Open "SELECT VDate,AHead,Debit,Credit " & _
'                    "From Voucher where VDate='" & CurrentDate.value & "' " & _
'                    "And Posted = 'Posted' " & _
'                    "GROUP BY VDate,AHead, Debit, Credit", cn, adOpenStatic, adLockReadOnly


     rsMaster.Open "SELECT   VID, VDate,AHead, Debit, Credit, " & _
                    "AMode , Description, strTime, UName " & _
                    "From Voucher " & _
...
'      rsMaster.Open "SELECT VDate,AHead,Debit,Credit " & _
'                    "From Voucher where VDate BETWEEN '" & FDate.value & "' AND '" & TDate.value & "' " & _
'                    "And Posted = 'Posted' " & _
'                    "GROUP BY AHead, Debit, Credit", cn, adOpenStatic, adLockReadOnly
...
On Error GoTo ErrH
    ...
    End If
        ...
        strPath = App.Path + "\reports\Cash Book.rpt"
  ...
  If OpCustomDate.value = True Then
   ...
   End If
        ...
        objReport.Preview "Cash Book Statement", , , , , 16777216 Or 524288 Or 65536
