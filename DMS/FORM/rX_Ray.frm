...
Begin VB.Form rX_Ray 
   ...
   Begin MSComCtl2.DTPicker Dt 
      ...
      CurrentDate     =   37114
   End
   Begin VB.ComboBox comFolder_Name 
      Height          =   315
      Left            =   600
      TabIndex        =   8
      Top             =   1650
      Width           =   2745
   End
   Begin VB.TextBox txtFolder_Name 
      Appearance      =   0  'Flat
      BorderStyle     =   0  'None
      Height          =   225
      Left            =   120
...
Private Sub CmdPreview_Click()
    If txtPat_ID1.text = "" Then Exit Sub
    CRViewer1_MODE = 9
    Viewer.Show vbModal
End Sub

Private Sub cmdPrint_Click()
    If Trim(txtPat_ID1.text) = "" Then Exit Sub
        ...
        '==========direct print==========================
            ...
            Report9.FormulaFields.Item(2).text = Chr(34) & "Patient ID" & Chr(34)
            Report9.FormulaFields.Item(3).text = Chr(34) & "Received Date" & Chr(34)
            Report9.FormulaFields.Item(4).text = Chr(34) & "Delivered Date" & Chr(34)
            Report9.FormulaFields.Item(5).text = Chr(34) & "Patient Name" & Chr(34)
...
Private Sub comFolder_Name_Click()
...
On Error Resume Next
    ...
    txtFolder_Name.text = comFolder_Name.text
...
Private Sub Form_Load()
    ...
    Adodc8.RecordSource = "exec m_name_select 2,'" + "X-RAY" + "'"
    Adodc8.Refresh
...
Private Sub DataGrid1_DblClick()
    ...
    If DataGrid1.Columns(0).value = rX_Ray.txtM_Code Then
    ...
    DataGrid1.Visible = False
    Else
    MsgBox "This Test is not for X-RAY Reporting Screen"
    End If
End Sub
...
End If
    ...
    If Adodc6.Recordset.RecordCount > 0 Then
        DataGrid1.Visible = False
         txtN_Exam = Adodc6.Recordset!Field1
         comFolder_Name.text = Adodc6.Recordset!Field2
         txtAdvice = Adodc6.Recordset!Field5
...
Public Sub Temp_rst1()
    ...
    DataGrid2.Columns(1).Width = 7515.213
  ...
  Adodc7.Refresh
    ...
    If Adodc7.Recordset.RecordCount > 0 Then
       Do Until Adodc7.Recordset.EOF
          comFolder_Name.AddItem Adodc7.Recordset!Test_Name
...
Private Sub GetResult()
  Adodc7.connectionstring = strcn.Connection
  Adodc7.RecordSource = "exec test_result_select 1,'" + comFolder_Name + "','" + "11" + "'"
  Adodc7.Refresh
  
    If Adodc7.Recordset.RecordCount > 0 Then
    ComTest_Name.text = Adodc7.Recordset!Test_result
    End If
End Sub
Private Sub GetResult1()
  Adodc7.connectionstring = strcn.Connection
  Adodc7.RecordSource = "exec test_result_select5 1,'" + Trim(comFolder_Name.text) + "','" + Trim(ComTest_Name.text) + "','" + "11" + "'"
  Adodc7.Refresh
  
    If Adodc7.Recordset.RecordCount > 0 Then
        txtTest_Result.text = Adodc7.Recordset!unit

    End If

End Sub
Private Sub GetImpression()
  Adodc7.connectionstring = strcn.Connection
  Adodc7.RecordSource = "exec test_result_select5 2,'" + Trim(comFolder_Name.text) + "','" + Trim(ComTest_Name.text) + "','" + "11" + "'"
  Adodc7.Refresh
  
    If Adodc7.Recordset.RecordCount > 0 Then
    txtNote.text = Adodc7.Recordset!ref_range
...
Private Sub BindTestName()
    ...
    comFolder_Name.Clear
       ...
       If rs.EOF = False Then
          Do Until rs.EOF
            comFolder_Name.AddItem rs!Test_Name
          rs.MoveNext
          Loop
       End If
       rs.Close
...
If Temp_Table1.RecordCount > 0 Then
    Temp_Table1.MoveFirst
        ...
        While Temp_Table1.EOF = False
            ...
            If Temp_Table1!Test_Name = ComTest_Name And Trim(txtFolder_Name) = Trim(comFolder_Name.text) Then
                Check = 1
            End If
    Temp_Table1.MoveNext
        Wend
