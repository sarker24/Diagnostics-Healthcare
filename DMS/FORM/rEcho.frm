...
Begin VB.Form rEchocardiography 
   BackColor       =   &H00C0B4A9&
   Caption         =   "Lab Report Format [ECHOCARDIOGRAPHY]"
   ClientHeight    =   8595
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   11280
   ...
   Begin VB.TextBox txtUsed_tech 
      ...
      TabIndex        =   6
      TabStop         =   0   'False
      Text            =   "M-MODE & 2-DIMENSIONAL ECHOCARDIOGRAPHY"
      Top             =   1515
      Width           =   6795
   End
   ...
   End
End
Attribute VB_Name = "rEchocardiography"
...
Private Sub cmdPrint_Click()
     '==========direct print==========================
            ...
            Report8.FormulaFields.Item(2).Text = Chr(34) & "PATIENT ID" & Chr(34)
            Report8.FormulaFields.Item(3).Text = Chr(34) & "RECEIVED ON" & Chr(34)
            Report8.FormulaFields.Item(4).Text = Chr(34) & "DELIVERED ON" & Chr(34)
            Report8.FormulaFields.Item(5).Text = Chr(34) & "PATIENT NAME" & Chr(34)
            Report8.FormulaFields.Item(6).Text = Chr(34) & "AGE" & Chr(34)
            Report8.FormulaFields.Item(7).Text = Chr(34) & "SEX" & Chr(34)
            Report8.FormulaFields.Item(8).Text = Chr(34) & "REFERED BY" & Chr(34)
            '--------------------------------------------------------------------
...
'Private Sub ComTest_Name1_LostFocus()
'    GetResult2
'End Sub

Private Sub DataGrid2_DblClick()
'   ComTest_Name1.Text = DataGrid2.Columns(0)
'    txtTest_Result1.Text = DataGrid2.Columns(1)
...
Private Sub Form_KeyPress(KeyAscii As Integer)
    If KeyAscii = 27 Then
    If rEchocardiography.DataGrid1.Visible = True Then
        rEchocardiography.DataGrid1.Visible = False
    Else
        Unload Me
    End If
    End If
...
Private Sub Form_Load()
    ...
    Adodc8.RecordSource = "exec m_name_select 2,'" + "OTHERS" + "'"
    Adodc8.Refresh
...
''DataGrid2.Columns(0).Width = 4259.906
''DataGrid2.Columns(1).Width = 5430.047
...
'txtChamber.Text = "LV : Cavity sizes & wall thickness are within normal limits" & Chr(13) & _
'                  "Normal regional & global wall motion." & Chr(13) & _
'                  "Good systolic function with FS of .%" & Chr(13) & _
'                  "LV,RV & RA sizes are within normal limits." & _
'                  "Good RV systolic function"
'txtValves.Text = "The four cardiac valves are normal in appearance and motion."
'txtChamber.Text = "LV : Cavity sizes & wall thickness are within normal limits" & Chr(13) & _
'                  "Normal regional & global wall motion." & Chr(13) & _
'                  "Good systolic function with FS of .%" & Chr(13) & _
'                  "LV,RV & RA sizes are within normal limits." & Chr(13) & _
'                  "Good RV systolic function"
'
'txtIAS_IVS.Text = "Intact"
'txtEvidance.Text = "No evidance of intracardiac shunt, mass or pericardial pathology."
'txtNote.Text = "Normal Study"
'-----------------------------------------
StrScreenName = "Echocardiagraphy"
Flush_Font_Type
...
'        txtN_Exam = Adodc6.Recordset!Field2
         ...
         ComTest_Name = Adodc6.Recordset!Field2
         txtTest_Result = Adodc6.Recordset!Field3
         txtTest_Result1 = Adodc6.Recordset!Field4
         'txtIAS_IVS = Adodc6.Recordset!Field6
         txtEvidance = Adodc6.Recordset!Field6
...
'    DataGrid2.Refresh
'
'    DataGrid2.Columns(0).Width = 2729.764
'    DataGrid2.Columns(1).Width = 7409.764
...
'    While Temp_Table1.EOF = False
          ...
          cmd.CommandText = "exec pro_Report_All 'I','" + Trim(txtPat_ID) + _
            ...
            "','" + Trim(txtTest_Result.Text) + _
            "','" + txtTest_Result1.Text + _
            "','" + "" + _
            "','" + txtEvidance + _
            "','" + "" + _
            "','" + "" + _
...
'        While Temp_Table1.EOF = False
'
'            If Temp_Table1!Test_Name = ComTest_Name1 Then
'                Check = 1
'            End If
'    Temp_Table1.MoveNext
'        Wend
...
'+++to insert into TEMPORARY RECORDSET "Temp_rst1"++++
'        Temp_Table1.AddNew
'        Temp_Table1!Test_Name = ComTest_Name1
'        Temp_Table1!test_result = txtTest_Result1
''        Temp_Table1!Unit = txtUnit
''        Temp_Table1!Ref_Range = txtRef_Range
'        DataGrid2.Refresh
'+++++++++++++++++++++++++++++++++++++++
...
Private Sub GetTestName()
  ...
  Adodc7.RecordSource = "exec test_result_select1 1,'" + "13C" + "'"
  Adodc7.Refresh

    If Adodc7.Recordset.RecordCount > 0 Then
       Do Until Adodc7.Recordset.EOF
'          ComTest_Name.AddItem Adodc7.Recordset!Test_Name
           ComTest_Name.Text = Adodc7.Recordset!Test_Name
       Adodc7.Recordset.MoveNext
       Loop
    End If
End Sub
Private Sub GetEvidance()
  Adodc7.connectionstring = strcn.Connection
  Adodc7.RecordSource = "exec test_result_select1 2,'" + "13CD" + "'"
  Adodc7.Refresh

    If Adodc7.Recordset.RecordCount > 0 Then
       Do Until Adodc7.Recordset.EOF
'         ComTest_Name.AddItem Adodc7.Recordset!Test_Name
         txtEvidance.Text = Adodc7.Recordset!unit
       Adodc7.Recordset.MoveNext
       Loop
    End If
End Sub
Private Sub GetTestName1()
  ...
  'Adodc10.RecordSource = "exec test_result_select1 1,'" + "13CD" + "'"
  Adodc10.RecordSource = "exec Flush_Test_Result 1,'" & txtM_Code & "','" & txtM_Code & "','" & StrSub_Code & "'"
  Adodc10.Refresh

    If Adodc10.Recordset.RecordCount > 0 Then
       Do Until Adodc10.Recordset.EOF
            ComTest_Name.Text = Adodc10.Recordset!Test_Name
            txtTest_Result.Text = Adodc10.Recordset!Test_result
            txtTest_Result1.Text = Adodc10.Recordset!unit
...
'  Adodc7.connectionstring = strcn.Connection
'  Adodc7.RecordSource = "exec test_result_select 1,'" + ComTest_Name + "','" + "13C" + "'"
'  Adodc7.Refresh
'
'    If Adodc7.Recordset.RecordCount > 0 Then
...
Private Sub GetResult1()
  Adodc7.connectionstring = strcn.Connection
  Adodc7.RecordSource = "exec test_result_select1 3,'" + "13C" + "'"
  Adodc7.Refresh
...
'  Adodc7.connectionstring = strcn.Connection
'  Adodc7.RecordSource = "exec test_result_select 1,'" + Trim(ComTest_Name1.Text) + "','" + "13CD" + "'"
'  Adodc7.Refresh
'
'    If Adodc7.Recordset.RecordCount > 0 Then
...
Private Sub BindTestName()
    On Error GoTo err_loop
       ...
       If RS.EOF = False Then
          'Do Until RS.EOF
            ComTest_Name.Text = RS!Test_Name
            txtTest_Result.Text = RS!Test_result
            txtTest_Result1.Text = RS!unit
            txtNote.Text = RS!ref_range
            'Dim sst As String
            'sst = RS!Test_Name
            'MsgBox sst
          RS.MoveNext
