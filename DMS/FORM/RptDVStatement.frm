...
Begin VB.Form RptDVStatement 
   ...
   Begin VB.Frame FraDateSelect 
      ...
      Begin VB.OptionButton OpCustomDate 
         ...
         Width           =   1815
      End
      Begin VB.ComboBox CmbDoctorName 
         Height          =   315
         Left            =   1440
         TabIndex        =   1
         TabStop         =   0   'False
      ...
      Begin MSComctlLib.ImageList ImageList1 
         ...
         BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
            ...
            BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "RptDVStatement.frx":000C
               Key             =   ""
            EndProperty
            BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "RptDVStatement.frx":08E6
               Key             =   ""
            EndProperty
            BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "RptDVStatement.frx":11C0
               Key             =   ""
            EndProperty
         EndProperty
      End
      ...
      Begin MSComCtl2.DTPicker TDate 
         ...
         CurrentDate     =   37114
      End
      Begin MSAdodcLib.Adodc dcDName 
         Height          =   330
         Left            =   120
         Top             =   2640
         Visible         =   0   'False
   ...
   End
End
Attribute VB_Name = "RptDVStatement"
...
Private Sub CmbDoctorName_KeyPress(KeyAscii As Integer)
   KeyAscii = AutoMatchCBBox(CmbDoctorName, KeyAscii)
   If KeyAscii = 13 Then
       SendKeys Chr(9)
    End If
End Sub
...
Dim rsTemp2 As New ADODB.Recordset
    ...
    While Not rsTemp2.EOF
        CmbDoctorName.AddItem rsTemp2("doc_name")
        rsTemp2.MoveNext
    Wend
    rsTemp2.Close
...
'     dcSWaiter.RecordSource = "SELECT  AccountsHead,WaiterRemaks FROM tblAccountsHead ORDER BY AccountsHead"
'     cmbWaiter.DataMode = ssDataModeBound
'     Set cmbWaiter.DataSource = dcSWaiter
'     cmbWaiter.DataSourceList = dcSWaiter
'     cmbWaiter.DataFieldList = "AccountsHead"
'     cmbWaiter.DataField = "AccountsHead"
...
Private Function Validate() As Boolean
        ...
        If FDate.value > TDate.value Then
            MsgBox "Invalid Date and select Valid Date range", vbInformation, "Genelral Ledger Report"
            FDate.SetFocus
            Validate = False
            Exit Function
        End If
...
Public Function FetchData()
    ...
    rsMaster.Open "SELECT PID,VDate,PatientName, Doctor,Age,PhoneNo, Amount,  " & _
                    "UName,Posted " & _
                    "From Doctor_Serial " & _
                    "WHERE    VDate='" & CurrentDate.value & "' AND Posted = 'Posted' and Doctor='" & parseQuotes(CmbDoctorName) & "'", cn, adOpenStatic, adLockReadOnly
     ...
     rsMaster.Open "SELECT PID,VDate,PatientName, Doctor,Age,PhoneNo, Amount,  " & _
                    ...
                    "'" & TDate.value & "' AND Posted = 'Posted' and Doctor='" & parseQuotes(CmbDoctorName) & "'", cn, adOpenStatic, adLockReadOnly
...
On Error GoTo ErrH
    ...
    End If
        ...
        strPath = App.Path + "\reports\Doctor Visit.rpt"
   ...
   Set objReportFF = objReportFormulaFieldDefinations.Item(4)
              objReportFF.text = "'" + CmbDoctorName + "'"
  ...
  If OpCustomDate.value = True Then
   ...
   End If
        ...
        objReport.Preview "Doctor's visit Report of + CmbDoctorName", , , , , 16777216 Or 524288 Or 65536
...
ErrH:
    ...
    Select Case Err.Number
        Case 20545
            MsgBox "Request cancelled by the user", vbInformation, "Doctor's visit Report"
        Case Else
            MsgBox "Error " & Err.Number & " - " & Err.Description, vbCritical, "Doctor's visit Report"
    End Select
End Sub
