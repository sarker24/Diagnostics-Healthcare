...
Begin VB.Form rImmunology 
   BackColor       =   &H00C0B4A9&
   Caption         =   "Lab Report Format [IMMUNOLOGY]"
   ClientHeight    =   8595
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   11445
   DrawWidth       =   2
   Icon            =   "rImmunology.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form2"
   LockControls    =   -1  'True
   MaxButton       =   0   'False
   ...
   End
End
Attribute VB_Name = "rImmunology"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
Dim Temp_Table1 As New ADODB.Recordset
Dim Create_temp As New ADODB.Recordset
...
Private Sub CmdPreview_Click()
    If Me.txtPat_ID1 = "" Then Exit Sub
    CRViewer1_MODE = 10
    Viewer.Show vbModal
End Sub
...
'            Report10.Text30.SetText Trim(rImmunology.DataGrid2.Columns(0).value)
'            Report10.Text31.SetText Trim(rImmunology.DataGrid2.Columns(1).value)
'            Report10.Text32.SetText Trim(rImmunology.DataGrid2.Columns(2).value)
...
'    End If
    ...
    'Dim StMark As String
    'StMark = "1"
    If Temp_Table1.EOF = True Then
        MsgBox "Incomplete Report.."
     '   StMark = "0"
        Exit Sub
    End If
...
'    txtRef_Range.Text = DataGrid2.Columns(3)
End Sub
...
Private Sub Form_KeyPress(KeyAscii As Integer)
    If KeyAscii = 27 Then
        If rImmunology.DataGrid1.Visible = True Then
            rImmunology.DataGrid1.Visible = False
        Else
            Unload Me
        End If
    End If
...
Private Sub Form_Load()
    ...
    Adodc8.RecordSource = "exec m_name_select 2,'" + "IMMU" + "'"
    Adodc8.Refresh
    ...
    Dt.value = Now
    Temp_rst1
'------select data from 'test_result' TABLE------
     GetTestName
'------end------------------------------
...
'If Len(Trim(txtS_Code)) = 0 Then Exit Sub
 ...
 Temp_rst1
    ...
    If Adodc6.Recordset.RecordCount > 0 Then
        ...
        Text1 = Adodc6.Recordset!Field3
        txtTest_Title.text = Adodc6.Recordset!Field4
'        txtS_Index2 = Adodc6.Recordset!Field9
'        txtC_Index1 = Adodc6.Recordset!Field10
'        txtC_Index2 = Adodc6.Recordset!Field11
'        txtOpinion1 = Adodc6.Recordset!Field12
'        txtOpinion2 = Adodc6.Recordset!Field13
'        txtNote1 = Adodc6.Recordset!Field14
...
'/////////show in Temp_rst1//////////////
        ...
        Temp_Table_Helper1.Open "select * from report_all where pat_id='" + txtPat_ID + "' and s_code='" + txtS_Code + "'and m_code='" + txtM_Code + "'", con
          ...
          While Temp_Table_Helper1.EOF = False
                Temp_Table1.AddNew
                Temp_Table1!Test_Name = Temp_Table_Helper1!Field5
                Temp_Table1!Test_result = Temp_Table_Helper1!Field6
...
Public Sub Temp_rst1()
    ...
    DataGrid2.Columns(2).Width = 3400
'    DataGrid2.Columns(3).Width = 1814.74

    DataGrid2.Columns(0).Caption = "Name of Test"
    DataGrid2.Columns(1).Caption = "Result"
    DataGrid2.Columns(2).Caption = "Normal Values"
...
Private Sub InsReport_All_TempRst1()
    ...
    While Temp_Table1.EOF = False
          ...
          cmd.CommandText = "exec pro_Report_All 'I','" + Trim(txtPat_ID) + _
            ...
            "','" + ChkForQuote(Text1.text) + _
            "','" + ChkForQuote(txtTest_Title.text) + _
...
Private Sub GetTestName()
  ...
  'Adodc7.RecordSource = "exec test_result_select1 1,'" + "03" + "'"
  Adodc7.RecordSource = "exec Flush_Test_Result 1,'" & "03" & "','" & txtM_Code & "','" & StrSub_Code & "'"
  Adodc7.Refresh
    ...
    If Adodc7.Recordset.RecordCount > 0 Then
       Do Until Adodc7.Recordset.EOF
          ...
          txtSN.text = Adodc7.Recordset!others1
...
Private Sub GetResult()
  Adodc7.connectionstring = strcn.Connection
  Adodc7.RecordSource = "exec test_result_select 1,'" + ComTest_Name + "','" + "03" + "'"
  Adodc7.Refresh
...
'DataGrid2.Columns(2).Width = 1769.953
'DataGrid2.Columns(3).Width = 1785.26
'DataGrid2.Columns(0).Value

End Sub
Private Sub GetUsed_Tech()

  Adodc7.connectionstring = strcn.Connection
  Adodc7.RecordSource = "exec test_Result_Select13 '" & txtPat_ID & "','" & ComTest_Name.text & "'"
  Adodc7.Refresh

    If Adodc7.Recordset.RecordCount > 0 Then
    'Do Until Adodc7.Recordset.EOF
    
    Text1.text = Adodc7.Recordset!others1
...
Private Sub GetUsed_Tech1()

  Adodc7.connectionstring = strcn.Connection
  Adodc7.RecordSource = "exec test_Result_Select17 '" & txtPat_ID & "','" & ComTest_Name.text & "'"
  Adodc7.Refresh
...
'    Dim sstt As String
'    sstt = Adodc7.Recordset!ref_range
'    MsgBox sstt
    Adodc7.Recordset.MoveNext
    'Loop
...
Private Sub GetNote()
  ...
  Adodc7.connectionstring = strcn.Connection
  Adodc7.RecordSource = "exec test_Result_Select18 '" & txtPat_ID & "','" & ComTest_Name.text & "'"
  Adodc7.Refresh
