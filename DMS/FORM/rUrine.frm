...
Begin VB.Form rUrine 
   BackColor       =   &H00C0B4A9&
   Caption         =   "LAB REPORT OF URINE"
   ClientHeight    =   9045
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   11625
   Icon            =   "rUrine.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
...
Private Sub cmdPrint_Click()
    '==========direct print==========================
            ...
            Report43.FormulaFields.Item(2).text = Chr(34) & "Patient ID" & Chr(34)
            Report43.FormulaFields.Item(3).text = Chr(34) & "Received Date" & Chr(34)
            Report43.FormulaFields.Item(4).text = Chr(34) & "Delivered Date" & Chr(34)
            Report43.FormulaFields.Item(5).text = Chr(34) & "Patient Name" & Chr(34)
            ...
            Report43.FormulaFields.Item(11).text = Chr(34) & "Urine Examination Report" & Chr(34)
            ...
            Report43.FormulaFields.Item(15).text = Chr(34) & "Normal Values" & Chr(34)
...
Private Sub Form_KeyPress(KeyAscii As Integer)
    If KeyAscii = 27 Then
    If rUrine.DataGrid1.Visible = True Then
        rUrine.DataGrid1.Visible = False
    Else
        Unload Me
    End If
    End If
...
Private Sub GetResult()
  Adodc7.connectionstring = strcn.Connection
  Adodc7.RecordSource = "exec test_result_select 3,'" & ComTest_Name & "','" & txtM_Code & "'"
  Adodc7.Refresh
    ...
    ComTest_Name.Clear
       ...
       If rs.EOF = False Then
          Do Until rs.EOF
            ...
            ComTest_Name.AddItem rs!Test_result
          rs.MoveNext
          Loop
       End If
       rs.Close
...
Private Sub GetUsed_Tech()
  ...
  Adodc7.connectionstring = strcn.Connection
  Adodc7.RecordSource = "exec test_Result_Select10 '" & txtPat_ID.text & "','" & ComTest_Name.text & "'"
  Adodc7.Refresh
