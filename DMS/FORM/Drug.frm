...
Begin VB.Form rDrug 
   ...
   Begin VB.TextBox txtUsed_tech 
      ...
      Left            =   2235
      TabIndex        =   8
      Text            =   "ESTIMATIONS ARE CARRIED OUT BY FLUORESCENCE POLARIZATION IMMUNO ASSAY : TDx SYSTEM ( ABBOTT )."
      Top             =   2520
      Width           =   6795
   End
...
Private Sub Form_Load()
    ...
    Adodc8.RecordSource = "exec m_name_select 2,'" + "DRUG TEST" + "'"
    Adodc8.Refresh
